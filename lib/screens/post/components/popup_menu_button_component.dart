        ...
        itemBuilder: (context) => <PopupMenuEntry>[
          ...
          PopupMenuItem(
            ...
            child: TextIcon(
                ...
                prefix: Image.asset(ic_star, color: appStore.isDarkMode ? bodyDark : bodyWhite, width: 16, height: 16)),
            textStyle: primaryTextStyle(),
          ),
          if (widget.post.isPinned == 0 || widget.post.canUnpinPost.validate().getBoolInt())
            PopupMenuItem(
              ...
              child: TextIcon(
                  ...
                  textStyle: secondaryTextStyle(),
                  prefix: Image.asset(ic_push_pin, color: appStore.isDarkMode ? bodyDark : bodyWhite, width: 16, height: 16)),
              textStyle: primaryTextStyle(),
            ),
          PopupMenuItem(
            value: 7,
