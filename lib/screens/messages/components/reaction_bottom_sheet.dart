      ...
      children: [
        ...
        Column(
          ...
          children: widget.meta!.reactions!.map((e) {
            int iconIndex = appStore.emojiList.indexWhere((x) => x.skins.validate().first.unified.validate() == e.reaction.validate());
            String reaction = appStore.emojiList[iconIndex].skins.validate().first.native.validate();
