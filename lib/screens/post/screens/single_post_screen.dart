      ...
      likePost(postId: post.activityId.validate()).then((value) {
        ...
        if (!isLike) {
          if (likeList.length <= 3) {
            likeList.removeWhere((element) => element.userId == userStore.loginUserId);
          }
          likeCount--;
        }
                                ...
                                children: [
                                  ...
                                  if (post.commentCount.validate() > 0)
                                    Align(
                                      ...
                                      child: Text(
                                        post.commentCount.validate() > 0 ? '${language.viewAll} ${language.comments}' : language.comments.capitalizeFirstLetter(),
