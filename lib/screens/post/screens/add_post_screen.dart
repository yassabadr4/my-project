...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Future<void> getMediaList() async {
    ...
    mediaTypeList = widget.component != null ? appStore.allowedMedia.firstWhere((element) => element.component == widget.component.validate()).allowedTypes : appStore.allowedMedia.first.allowedTypes;
    setState(() {});
  }
  ...
  Future<void> onSelectMedia() async {
    ...
    if (file != null) {
      if (file == FileTypes.CAMERA) {
        ...
        getMultipleFiles(mediaType: selectedMedia!, postingInComponent: widget.component.validate()).then((value) {
                ...
                ifNotTester(() async {
                  if (mediaList.isEmpty && postContentTextKey.currentState!.controller!.text.isEmpty && gif == null) {
                    ...
                    await uploadPost(
                      ...
                      postIn: dropdownValue.id.toString(),
