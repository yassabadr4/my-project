...
Future<List<LmsPaymentModel>> getLmsPayments() async {
  Iterable it = await handleResponse(await buildHttpResponse('${APIEndPoint.socialVApiEndPoint}/${APIEndPoint.learnPressEndPoint}/${APIEndPoint.paymentsEndPoint}/${APIEndPoint.methodsEndPoint}'));
