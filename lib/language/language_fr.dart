...
class LanguageFr extends BaseLanguage {
  ...
  @override
  String get accountActivatedText => "Votre compte a été activé avec succès! Vous pouvez maintenant vous connecter avec le nom d'utilisateur et le mot de passe que vous avez fournis lorsque vous vous êtes inscrit.";
