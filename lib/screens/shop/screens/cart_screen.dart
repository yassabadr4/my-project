...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<List<CartItemModel>> getCart({String? orderBy}) async {
    ...
    await getCartDetails().then((value) {
      ...
      appStore.setCartCount(cartItemList.validate().length);
    }).catchError((e) {
      isError = true;
      appStore.setLoading(false);
          ...
          children: [
            FutureBuilder<List<CartItemModel>>(
              ...
              builder: (ctx, snap) {
                ...
                if (cartItemList.isEmpty && !appStore.isLoading) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        16.height,
                        if (cart != null && cart!.coupons.validate().isNotEmpty)
                        ...
                        if (cart != null && cart!.coupons.validate().isEmpty)
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              SizedBox(
            ...
            Observer(builder: (context) => LoadingWidget().center().visible(appStore.isLoading))
          ],
        ),
      ),
    );
