...
class MemberVerifiedNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        cachedImage(userStore.loginAvatarUrl, height: 40, width: 40, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
        8.width,
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            RichText(
              text: TextSpan(
                children: [
                  WidgetSpan(
                    child: Text('${userStore.loginFullName} ', style: boldTextStyle(size: 14,fontFamily: fontFamily)).onTap(() {
                      MemberProfileScreen(memberId: userStore.loginUserId.toInt()).launch(context);
