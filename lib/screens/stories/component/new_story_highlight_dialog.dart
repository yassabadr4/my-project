...
class _NewStoryHighlightDialogState extends State<NewStoryHighlightDialog> {
  ...
  HighlightStoriesModel dropdownValue = HighlightStoriesModel();
    ...
    if (file != null) {
      if (file == FileTypes.CAMERA) {
        await getImageSource(isCamera: true).then((value) {
          ...
          CreateStoryScreen(
            cameraImage: value,
            categoryId: showNewCategory ? '' : dropdownValue.categoryId.validate().toString(),
            categoryName: showNewCategory ? categoryName.text.validate() : dropdownValue.categoryName,
              ...
              if (showNewCategory.validate())
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (dropdownValue.categoryId != null)
                      Container(
                        width: context.width(),
                        ...
                        child: DropdownButtonHideUnderline(
                          child: ButtonTheme(
                            ...
                            child: DropdownButton<HighlightStoriesModel>(
                              ...
                              isExpanded: true,
                              onChanged: (HighlightStoriesModel? newValue) {
                                setState(() {
                                  dropdownValue = newValue!;
                                });
                              },
                              items: highlightList.map<DropdownMenuItem<HighlightStoriesModel>>((e) {
                                return DropdownMenuItem<HighlightStoriesModel>(
                                  value: e,
                                  child: Text(e.categoryName.validate().isNotEmpty ? e.categoryName.validate() : language.untitled, overflow: TextOverflow.ellipsis, maxLines: 1),
                                );
                              }).toList(),
                            ),
                          ),
